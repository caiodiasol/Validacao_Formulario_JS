...
form.addEventListener('submit', function (e) {
    ...
    const mensagemDeSucessoTexto = `Formulário VALIDADO pois o ${valorNumeroB} é  maior do que o ${valorNumeroA}`;
    const mensagemDeErroTexto = `Formulário INVALIDADO pois o ${valorNumeroB} não é  maior do que o ${valorNumeroA}`; 
